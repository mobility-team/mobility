...
It is developed mainly by `AREP <https://world.openfoodfacts.org>`_ and `Elioth <https://elioth.com>`_ with `ADEME <https://wiki.resilience-territoire.ademe.fr/wiki/Mobility>`_ support, but anyone can join us!
