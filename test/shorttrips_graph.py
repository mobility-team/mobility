...
def proportion_déplacement(a):
    ...
    if a == "catégorie_urbaine":
        ...
        fig = go.Figure(
            ...
            data=[
                go.Bar(name='ENTD-2008', x=short_trips_2008["city_category"].tolist(), y=short_trips_2008["ratio"].tolist(), yaxis='y', offsetgroup=1, marker=dict(color = "rgb(236, 0, 141)")),
                go.Bar(name='EMP-2019', x=short_trips_2019["city_category"].tolist(), y=short_trips_2019["ratio"].tolist(), yaxis='y', offsetgroup=2, marker=dict(color = "rgb(11, 28, 45)"))
                ],
        ...
        fig = go.Figure(
            ...
            data=[
                go.Bar(name='ENTD-2008', x=short_trips_2008["city_category"].tolist(), y=short_trips_2008["nbre_trajets"].tolist(), yaxis='y', offsetgroup=1, marker=dict(color = "rgb(236, 0, 141)")),
                go.Bar(name='EMP-2019', x=short_trips_2019["city_category"].tolist(), y=short_trips_2019["nbre_trajets"].tolist(), yaxis='y', offsetgroup=2, marker=dict(color = "rgb(11, 28, 45)"))
                ],
    ...
    if a == "csp":
        ...
        fig = go.Figure(
            ...
            data=[
                go.Bar(name='ENTD-2008', x=short_trips_2008["csp"].tolist(), y=short_trips_2008["ratio"].tolist(), yaxis='y', offsetgroup=1, marker=dict(color = "rgb(236, 0, 141)")),
                go.Bar(name='EMP-2019', x=short_trips_2019["csp"].tolist(), y=short_trips_2019["ratio"].tolist(), yaxis='y', offsetgroup=2, marker=dict(color = "rgb(11, 28, 45)"))
                ],
        ...
        fig = go.Figure(
            ...
            data=[
                go.Bar(name='ENTD-2008', x=short_trips_2008["csp"].tolist(), y=short_trips_2008["nbre_trajets"].tolist(), yaxis='y', offsetgroup=1, marker=dict(color = "rgb(236, 0, 141)")),
                go.Bar(name='EMP-2019', x=short_trips_2019["csp"].tolist(), y=short_trips_2019["nbre_trajets"].tolist(), yaxis='y', offsetgroup=2, marker=dict(color = "rgb(11, 28, 45)"))
                ],
    ...
    if a == "motifs":
        ...
        fig = go.Figure(
            ...
            data=[
                go.Bar(name='ENTD-2008', x=short_trips_2008["motive_group"].tolist(), y=short_trips_2008["ratio"].tolist(), yaxis='y', offsetgroup=1, marker=dict(color = "rgb(236, 0, 141)")),
                go.Bar(name='EMP-2019', x=short_trips_2019["motive_group"].tolist(), y=short_trips_2019["ratio"].tolist(), yaxis='y', offsetgroup=2, marker=dict(color = "rgb(11, 28, 45)"))
                ],
        ...
        fig = go.Figure(
            ...
            data=[
                go.Bar(name='ENTD-2008', x=short_trips_2008["motive_group"].tolist(), y=short_trips_2008["nbre_trajets"].tolist(), yaxis='y', offsetgroup=1, marker=dict(color = "rgb(236, 0, 141)")),
                go.Bar(name='EMP-2019', x=short_trips_2019["motive_group"].tolist(), y=short_trips_2019["nbre_trajets"].tolist(), yaxis='y', offsetgroup=2, marker=dict(color = "rgb(11, 28, 45)"))
                ],
    ...
    if a == "mode":
        ...
        fig = go.Figure(
            ...
            data=[
                go.Bar(name='ENTD-2008', x=short_trips_2008["mode_group"].tolist(), y=short_trips_2008["ratio"].tolist(), yaxis='y', offsetgroup=1, marker=dict(color = "rgb(236, 0, 141)")),
                go.Bar(name='EMP-2019', x=short_trips_2019["mode_group"].tolist(), y=short_trips_2019["ratio"].tolist(), yaxis='y', offsetgroup=2, marker=dict(color = "rgb(11, 28, 45)"))
                ],
        ...
        fig.update_layout(
            ...
            template="simple_white",
            font=dict(family="Gilroy Light",size=12),
            title_text="Répartition des trajets en fonction des mdoes de déplacement", title_x=0.5
            )
        ...
        fig = go.Figure(
            ...
            data=[
                go.Bar(name='ENTD-2008', x=short_trips_2008["mode_group"].tolist(), y=short_trips_2008["nbre_trajets"].tolist(), yaxis='y', offsetgroup=1, marker=dict(color = "rgb(236, 0, 141)")),
                go.Bar(name='EMP-2019', x=short_trips_2019["mode_group"].tolist(), y=short_trips_2019["nbre_trajets"].tolist(), yaxis='y', offsetgroup=2, marker=dict(color = "rgb(11, 28, 45)"))
                ],
...
def distance_par_trajet(a):
    ...
    if a == "catégorie_urbaine":
        short_trips_2019 = short_trips_2019.groupby(["city_category"], as_index=False).agg({"distance":['sum'], "individual_id": ["count"]})
        ...
        short_trips_2008 = short_trips_2008.groupby(["city_category"], as_index=False).agg({"distance":['sum'], "individual_id": ["count"]})
        ...
        fig = go.Figure(
            ...
            data=[
                go.Bar(name='ENTD-2008', x=short_trips_2008["city_category"].tolist(), y=short_trips_2008["distance"].tolist(), yaxis='y', offsetgroup=1, marker=dict(color = "rgb(236, 0, 141)")),
                go.Bar(name='EMP-2019', x=short_trips_2019["city_category"].tolist(), y=short_trips_2019["distance"].tolist(), yaxis='y', offsetgroup=2, marker=dict(color = "rgb(11, 28, 45)"))
                ],
    ...
    if a == "csp" :
        ...
        short_trips_2019 = short_trips_2019.groupby(["csp"], as_index=False).agg({"distance":['sum'], "individual_id": ["count"]})
        short_trips_2019.columns = ["csp", "distance", "nbre_trajets"]
        short_trips_2019["distance"] = short_trips_2019["distance"] / short_trips_2019["nbre_trajets"]
        
        short_trips_2008 = short_trips_2008.groupby(["csp"], as_index=False).agg({"distance":['sum'], "individual_id": ["count"]})
        ...
        fig = go.Figure(
            ...
            data=[
                go.Bar(name='ENTD-2008', x=short_trips_2008["csp"].tolist(), y=short_trips_2008["distance"].tolist(), yaxis='y', offsetgroup=1, marker=dict(color = "rgb(236, 0, 141)")),
                go.Bar(name='EMP-2019', x=short_trips_2019["csp"].tolist(), y=short_trips_2019["distance"].tolist(), yaxis='y', offsetgroup=2, marker=dict(color = "rgb(11, 28, 45)"))
                ],
...
def distance_quotidienne(a) :
    ...
    if a=="csp":
        ...
        short_trips_2019 = short_trips_2019.groupby(["individual_id", "pondki", "csp"], as_index=False).agg({"distance":['sum']})
        ...
        short_trips_2019 = short_trips_2019.groupby(["csp"], as_index=False).agg({"distance":['sum'], "pondki":["sum"], "individual_id": ["count"]})
        short_trips_2019.columns=["csp", "distance_quotidienne", "somme_pondki", "nombre_personnes"]
        short_trips_2019["distance_quotidienne"] = short_trips_2019["distance_quotidienne"] / short_trips_2019["somme_pondki"]
        
        short_trips_2008 = short_trips_2008.groupby(["individual_id", "pondki", "csp"], as_index=False).agg({"distance":['sum'], "day_id": ["nunique"]})
        ...
        short_trips_2008 = short_trips_2008.groupby(["csp"], as_index=False).agg({"distance":['sum'], "pondki":["sum"], "individual_id": ["count"], "nbre_jours": ["sum"]})
        short_trips_2008.columns=["csp", "distance_quotidienne", "somme_pondki", "nombre_personnes","nbre_jours"]
        short_trips_2008["distance_quotidienne"] = short_trips_2008["distance_quotidienne"] / short_trips_2008["somme_pondki"]
        ...
        fig = go.Figure(
            ...
            data=[
                go.Bar(name='ENTD-2008', x=short_trips_2008["csp"].tolist(), y=short_trips_2008["distance_quotidienne"].tolist(), yaxis='y', offsetgroup=1, marker=dict(color = "rgb(236, 0, 141)")),
                go.Bar(name='EMP-2019', x=short_trips_2019["csp"].tolist(), y=short_trips_2019["distance_quotidienne"].tolist(), yaxis='y', offsetgroup=2, marker=dict(color = "rgb(11, 28, 45)"))
                ],
    ...
    if a == "catégorie_urbaine":
        ...
        short_trips_2019 = short_trips_2019.groupby(["individual_id", "pondki", "city_category"], as_index=False).agg({"distance":['sum']})
        short_trips_2019.columns=["individual_id", "pondki", "city_category", "distance"]
        short_trips_2019["distance"]=short_trips_2019["distance"]*short_trips_2019["pondki"]
        short_trips_2019 = short_trips_2019.groupby(["city_category"], as_index=False).agg({"distance":['sum'], "pondki":["sum"], "individual_id": ["count"]})
        ...
        short_trips_2008 = short_trips_2008.groupby(["individual_id", "pondki", "city_category"], as_index=False).agg({"distance":['sum'], "day_id": ["nunique"]})
        short_trips_2008.columns=["individual_id", "pondki", "city_category", "distance", "nbre_jours"]
        short_trips_2008["distance"]=short_trips_2008["distance"]*short_trips_2008["pondki"]
        short_trips_2008["pondki"]=short_trips_2008["pondki"]*short_trips_2008["nbre_jours"]
        short_trips_2008 = short_trips_2008.groupby(["city_category"], as_index=False).agg({"distance":['sum'], "pondki":["sum"], "individual_id": ["count"], "nbre_jours": ["sum"]})
        short_trips_2008.columns=["catégorie_urbaine", "distance_quotidienne", "somme_pondki", "nombre_personnes","nbre_jours"]
        short_trips_2008["distance_quotidienne"] = short_trips_2008["distance_quotidienne"] / short_trips_2008["somme_pondki"]
        ...
        fig = go.Figure(
            ...
            data=[
                go.Bar(name='ENTD-2008', x=short_trips_2008["catégorie_urbaine"].tolist(), y=short_trips_2008["distance_quotidienne"].tolist(), yaxis='y', offsetgroup=1, marker=dict(color = "rgb(236, 0, 141)")),
                go.Bar(name='EMP-2019', x=short_trips_2019["catégorie_urbaine"].tolist(), y=short_trips_2019["distance_quotidienne"].tolist(), yaxis='y', offsetgroup=2, marker=dict(color = "rgb(11, 28, 45)"))
                ],
...
def taux_remplissage() :
    ...
    short_trips_2019 = short_trips_2019.groupby(["motive_group"], as_index=False).agg({"n_other_passengers":['sum'], "pondki":['sum'], "individual_id": ["count"]})
    short_trips_2019["n_other_passengers"] = short_trips_2019["n_other_passengers"] / short_trips_2019["pondki"]
    short_trips_2019["survey"]="EMP-2019"
    ...
    short_trips_2008 = short_trips_2008.groupby(["motive_group"], as_index=False).agg({"n_other_passengers":['sum'],"pondki":['sum'], "individual_id": ["count"]})
    short_trips_2008["n_other_passengers"] = short_trips_2008["n_other_passengers"] / short_trips_2008["pondki"]
    short_trips_2008["survey"]="ENTD-2008"
    ...
    fig = go.Figure(
        ...
        data=[
            go.Bar(name='ENTD-2008', x=short_trips_2008["motive_group"].tolist(), y=short_trips_2008["n_other_passengers"].tolist(), yaxis='y', offsetgroup=1, marker=dict(color = "rgb(236, 0, 141)")),
            go.Bar(name='EMP-2019', x=short_trips_2019["motive_group"].tolist(), y=short_trips_2019["n_other_passengers"].tolist(), yaxis='y', offsetgroup=2, marker=dict(color = "rgb(11, 28, 45)"))
            ],
...
def distances_quotidiennes_motif(csp="",city_category="",day=""):
    ...
    short_trips_2019 = short_trips_2019.groupby(["individual_id", "pondki"], as_index=False).agg({"day_id": ["nunique"]})
    ...
    short_trips_2008 = short_trips_2008.groupby(["individual_id", "pondki"], as_index=False).agg({"day_id": ["nunique"]})
    ...
    fig = px.bar(distance_totale, x="survey", y="distance", color='motive_group', text_auto=True, color_discrete_map=color_motive)
    fig.update_layout(
...
def émissions_dist_motifs():
    ...
    fig = go.Figure(
        ...
        data=[
            go.Bar(name='émissions', x=short_trips_2019["motive_group"].tolist(), y=short_trips_2019["ef"].tolist(), yaxis='y', offsetgroup=1, marker=dict(color = "rgb(236, 0, 141)")),
            go.Bar(name='distances', x=short_trips_2019["motive_group"].tolist(), y=short_trips_2019["distance"].tolist(), yaxis='y2', offsetgroup=2, marker=dict(color = "rgb(11, 28, 45)"))
            ],
        layout={
    ...
    fig.update_layout(
        ...
        template="simple_white",
        font=dict(family="Gilroy Light",size=12),
        title_text="Distances et émissions moyennes par déplacement <br>en fonction du motif de déplacement", title_x=0.5
        )
