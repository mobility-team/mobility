...
import os
# mobility utils
import mobility.trip_sampler as tp
import mobility.carbon_computation as cc
import mobility.population as population
...
if __name__ == "__main__":
    ...
    cities_folder_path = (
        Path(os.path.dirname(__file__)).parents[1] / "examples/Empreinte carbone"
    )
    cities_file_path = cities_folder_path/ "cities_category.csv"

    cities_category = pd.read_csv(cities_file_path, dtype=str)
