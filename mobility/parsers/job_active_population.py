...
def prepare_job_active_population(proxies={}):
    ...
    db_job_active_pop = pd.read_csv(data_folder_path / "base-cc-emploi-pop-active-2019.csv",
                                    sep=';', usecols=['CODGEO',
                                                      'P19_ACT15P',
                                                      'C19_ACT1564_CS1', 'C19_ACT1564_CS2',
                                                      'C19_ACT1564_CS3', 'C19_ACT1564_CS4',
                                                      'C19_ACT1564_CS5', 'C19_ACT1564_CS6',
                                                      'P19_EMPLT',
                                                      'C19_EMPLT_CS1', 'C19_EMPLT_CS2',
                                                      'C19_EMPLT_CS3', 'C19_EMPLT_CS4',
                                                      'C19_EMPLT_CS5', 'C19_EMPLT_CS6'],
                                    dtype={'CODGEO':str})
    
    db_jobs = db_job_active_pop.loc[:, ['CODGEO', 'P19_EMPLT',
                                        'C19_EMPLT_CS1', 'C19_EMPLT_CS2', 'C19_EMPLT_CS3', 
                                        'C19_EMPLT_CS4', 'C19_EMPLT_CS5', 'C19_EMPLT_CS6']]
    db_jobs.set_index('CODGEO', inplace=True)
    db_jobs.rename(columns={'P19_EMPLT': 'n_jobs_total',
                            'C19_EMPLT_CS1': 'n_jobs_CS1', 'C19_EMPLT_CS2': 'n_jobs_CS2',
                            'C19_EMPLT_CS3': 'n_jobs_CS3', 'C19_EMPLT_CS4': 'n_jobs_CS4',
                            'C19_EMPLT_CS5': 'n_jobs_CS5', 'C19_EMPLT_CS6': 'n_jobs_CS6'},
                   inplace=True)
    
    db_active_population = db_job_active_pop.loc[:, ['CODGEO', 'P19_ACT15P',
                                                     'C19_ACT1564_CS1', 'C19_ACT1564_CS2',
                                                     'C19_ACT1564_CS3', 'C19_ACT1564_CS4',
                                                     'C19_ACT1564_CS5', 'C19_ACT1564_CS6']]
    db_active_population.set_index('CODGEO', inplace=True)
    db_active_population.rename(columns={'P19_ACT15P': 'active_pop',
