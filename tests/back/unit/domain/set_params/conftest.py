...
def clean_env(monkeypatch):
    ...
    for key in [
        ...
        "MOBILITY_R_HEARTBEAT_INTERVAL_SECONDS",
        "MOBILITY_R_IDLE_TIMEOUT_SECONDS",
        "MOBILITY_R_IDLE_CPU_PERCENT",
        "MOBILITY_R_IDLE_MEMORY_CHANGE_MB",
        "MOBILITY_R_CPU_CHECK_INTERVAL_SECONDS",
