...
resources_path = resources.files("mobility.resources")

insee_cities = pd.read_csv(resources_path / "insee/insee_RP2021_mobpro_border_cities.csv", header=None, names=["insee_id", "insee_name"])
...
bfs_cities = pd.read_excel(resources_path / "bfs/je-f-21.03.01.xlsx", skiprows=9, usecols=[0, 1], header=None, names=["bfs_id", "bfs_name"], nrows=2172)
